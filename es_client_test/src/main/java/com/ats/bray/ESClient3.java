...
@Controller
@RequestMapping("/")
public class ESClient3 extends  Thread{
    private int typeVal;
...
//              .execute()
//              .actionGet();
      IndexResponse response = client.prepareIndex("filesystem_es", "es_type","2")
    ...
    public static void main(String[] args) {
        ESClient3 esClient = new ESClient3();
//        esClient.init();
        while (true) {
            try {
