...
@Controller
@RequestMapping("/")
public class ESClient2 extends Thread{
    private int typeVal;
...
//                System.out.println("builder.toString 的值："+builder.string());
                IndexResponse response = client.prepareIndex("filesystem_es8", "es_data1"+this.typeVal)
...
//        }
        ...
        String headAndBody = jsonObject.toString();
...
//              .execute()
//              .actionGet();
        IndexResponse response = client.prepareIndex("filesystem_es1", "es_type5",String.valueOf(INDEX_ID++))
    ...
    public static void main(String[] args) {
        ...
        ESClient2 esClient = new ESClient2();
//        esClient.init();
        while (true) {
            try {
