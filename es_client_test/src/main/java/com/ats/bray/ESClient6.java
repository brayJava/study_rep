...
//            System.out.println("headAndBody===>" + jsonObject.toString());
            ...
            try {
                ...
                XContentBuilder builder = XContentFactory.jsonBuilder().startObject()
                        ...
                        .field("component", sb.append(jsonObject.toString())
...
//                System.out.println("builder.toString 的值："+builder.string());
                IndexResponse response = client.prepareIndex("filesystem_es", "es_type3",String.valueOf(INDEX_ID++))
...
//              .execute()
//              .actionGet();
      IndexResponse response = client.prepareIndex("filesystem_es", "es_type3","2")
    ...
    public static void main(String[] args) {
        ESClient6 esClient = new ESClient6();
        esClient.init();
        while (true) {
            try {
