...
@Controller
@RequestMapping("/")
public class ESClient1 extends Thread{
    private int typeVal;
...
//                System.out.println("builder.toString 的值："+builder.string());
                IndexResponse response = client.prepareIndex("filesystem_es8", "es_data"+this.typeVal)
...
//              .execute()
//              .actionGet();
        IndexResponse response = client.prepareIndex("filesystem_es1", "es_type8",String.valueOf(INDEX_ID++))
    ...
    public static void main(String[] args) {
        ESClient1 esClient = new ESClient1();
//        esClient.init();
        while (true) {
            try {
