...
import com.ats.bray.utils.JSONUtil;
import com.ats.bray.utils.PropertiesUtil;
...
@Controller
@RequestMapping("/")
public class ESClient extends Thread{

    Map<String, String> exMap = new HashMap<String, String>();

    private TransportClient client;

    private static int INDEX_ID = Integer.parseInt(PropertiesUtil.getProperty("INDEX_ID"));
        ...
        try {
            ...
            client = new PreBuiltTransportClient(settings)
                    .addTransportAddress(new InetSocketTransportAddress(InetAddress
                            .getByName(PropertiesUtil.getProperty("InetAddress")), Integer.parseInt(PropertiesUtil.getProperty("port"))));
...
//                System.out.println("builder.toString 的值："+builder.string());
                IndexResponse response = client.prepareIndex("filesystem_es8", PropertiesUtil.getProperty("es_type"))
...
//              .execute()
//              .actionGet();
      IndexResponse response = client.prepareIndex("filesystem_es", "es_data","2")
