...
@Controller
@RequestMapping("/")
public class ESClient5 extends Thread{
    private int typeVal;
    ...
    private static int INDEX_ID = 400;
...
//              .execute()
//              .actionGet();
      IndexResponse response = client.prepareIndex("filesystem_es", "EStype","2")
    ...
    public static void main(String[] args) {
        ESClient5 esClient = new ESClient5();
//        esClient.init();
        while (true) {
            try {
...
//        esClient.sendClientData();
    ...
    @RequestMapping("/toClientThread.do")
